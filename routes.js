...
exports = module.exports = function(app, passport) {
  ...
  app.get('/myevents/edit/:id', require('./views/myevents/index').read);
  app.post('/myevents/update/:id', require('./views/myevents/index').update);
  app.delete('/myevents/delete/:id', require('./views/myevents/index').delete);
